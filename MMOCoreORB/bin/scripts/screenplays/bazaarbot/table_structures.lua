BBStructuresConfig = {
	...
	qualityMin = 14,
	qualityAvg = 17, -- 10% chance to use this as the min value and qualityMax as the max value
	qualityMax = 20, -- 1% Chance to get up to +5 to the max value, with qualityMax as the min value
