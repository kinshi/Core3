...
BBArtisanItems = {
	...
	{950, 7, 1, 0, "survey_tool_flora", "survey_tool_gas", "survey_tool_liquid", "survey_tool_mineral", "survey_tool_moisture", "survey_tool_solar", "survey_tool_wind"},
	{12000, 3, 1, 0, "clothing_station", "food_station", "space_station", "structure_station", "weapon_station"},
