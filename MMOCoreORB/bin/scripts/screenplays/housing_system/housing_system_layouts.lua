...
-- Tip: If the site you are making has multiple vertical (z) levels, use the z level of the terminal for the site center, because the place structure command will always get the world z at location x,y itself, but the place object command used by the temrinal needs you to tell it the z location. 
--
...
layouts = {
	...
	smallFourOut = {
		...
		plots = {
			{ -- Plot 1
				plotName = "Small House (Your Left)", x = 9, y = 10.5, localRotation = 0,
				buildings = {
					{price = 15000, buildingName = "Tatooine: Small Style 1", template = "object/building/player/player_house_tatooine_small_style_01.iff", zoning = 0},
					{price = 15000, buildingName = "Tatooine: Small Style 2", template = "object/building/player/player_house_tatooine_small_style_02.iff", zoning = 0},
					{price = 50000, buildingName = "Tatooine: Bunker House", template = "object/building/player/player_house_tatooine_medium_style_02.iff", zoning = 0},
			...
			{ -- Plot 2
				plotName = "Small House (Your Right)", x = -9, y = 10.5, localRotation = 0,
				buildings = {
					{price = 15000, buildingName = "Tatooine: Small Style 1", template = "object/building/player/player_house_tatooine_small_style_01.iff", zoning = 0},
					{price = 15000, buildingName = "Tatooine: Small Style 2", template = "object/building/player/player_house_tatooine_small_style_02.iff", zoning = 0},
					{price = 50000, buildingName = "Tatooine: Bunker House", template = "object/building/player/player_house_tatooine_medium_style_02.iff", zoning = 0},
			...
			{ -- Plot 3
				plotName = "Small House (Your Left)", x = 9, y = -10.5, localRotation = 180,
				buildings = {
					{price = 15000, buildingName = "Tatooine: Small Style 1", template = "object/building/player/player_house_tatooine_small_style_01.iff", zoning = 0},
					{price = 15000, buildingName = "Tatooine: Small Style 2", template = "object/building/player/player_house_tatooine_small_style_02.iff", zoning = 0},
					{price = 50000, buildingName = "Tatooine: Bunker House", template = "object/building/player/player_house_tatooine_medium_style_02.iff", zoning = 0},
			...
			{ -- Plot 4
				plotName = "Small House (Your Right)", x = -9, y = -10.5, localRotation = 180,
				buildings = {
					{price = 15000, buildingName = "Tatooine: Small Style 1", template = "object/building/player/player_house_tatooine_small_style_01.iff", zoning = 0},
					{price = 15000, buildingName = "Tatooine: Small Style 2", template = "object/building/player/player_house_tatooine_small_style_02.iff", zoning = 0},
					{price = 50000, buildingName = "Tatooine: Bunker House", template = "object/building/player/player_house_tatooine_medium_style_02.iff", zoning = 0},
	...
	largeTwo = {
		terminal = {name = "Large Houses", x = 0, y = 15.8, localRotation = 0},
		plots = {
			{ -- Plot 1
				plotName = "Medium House (Your Left)", x = 18.4, y = 0, localRotation = 0,
				buildings = {
					{price = 175000, buildingName = "Tatooine: Large Style 1", template = "object/building/player/player_house_tatooine_large_style_01.iff", zoning = 0},
				},
			},
			{ -- Plot 2
				plotName = "Medium House (Your Right)", x = -18.4, y = 0, localRotation = 0,
				buildings = {
					{price = 175000, buildingName = "Tatooine: Large Style 1", template = "object/building/player/player_house_tatooine_large_style_01.iff", zoning = 0},
				},
			},
	...
	tatooineEstateSmall = {
		terminal = {name = "Bajaron Mannor", x = 0, y = 19, localRotation = 0},
		plots = {
			{ -- Plot 1
	...
	smallCityBlock = {
		terminal = {name = "Tatwi Village", x = 0, y = 22, localRotation = 0},
		plots = {
			{ -- Plot 1
	...
	enthaGuildHalls = {
		...
		plots = {
			{ -- Plot 1
				plotName = "Single Large Long Structure", x = 0, y = 0, localRotation = 0,
				buildings = {
				--	{price = 199000, buildingName = "University: Tatooine", template = "object/building/player/player_npc_university_tatooine.iff", zoning = 0}, -- inexplicably broken causing client crash........
					{price = 199000, buildingName = "Combat Guild Hall: Tatooine", template = "object/building/player/player_npc_combat_guildhall_tatooine.iff", zoning = 0},
					{price = 199000, buildingName = "Commerce Guild Hall: Tatooine", template = "object/building/player/player_npc_commerce_guildhall_tatooine.iff", zoning = 0},
				},
			},
