...
rebelRewardData = {
	weaponsArmorList = {
		...
		"ith_armor_s01_bicep_l",
		"ith_armor_s01_bicep_r",
		"ith_armor_s01_boots",
		"ith_armor_s01_bracer_l",
		"ith_armor_s01_bracer_r",
		"ith_armor_s01_chest_plate",
		"ith_armor_s01_gloves",
		"ith_armor_s01_helmet",
		"ith_armor_s01_leggings",
	...
	weaponsArmor = {
		...
		armor_kashyyykian_hunting_bracer_l = { index=12, type=factionRewardType.armor, display="@wearables_name:armor_kashyyykian_hunting_bracer_l", item="object/tangible/wearables/armor/kashyyykian_hunting/armor_kashyyykian_hunting_bracer_l.iff", cost=2000},
		...
		ith_armor_s01_bicep_l = { index=16, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_bicep_l", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_bicep_l.iff", cost=2000},
		ith_armor_s01_bicep_r = { index=17, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_bicep_r", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_bicep_r.iff", cost=2000},
		ith_armor_s01_boots = { index=18, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_boots", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_boots.iff", cost=3000},
		ith_armor_s01_bracer_l = { index=19, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_bracer_l", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_bracer_l.iff", cost=2000},	
		ith_armor_s01_bracer_r = { index=20, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_bracer_r", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_bracer_r.iff", cost=2000},	
		ith_armor_s01_chest_plate = { index=21, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_chest_plate", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_chest_plate.iff", cost=4000},	
		ith_armor_s01_gloves = { index=22, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_gloves", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_gloves.iff", cost=2000},
		ith_armor_s01_helmet = { index=23, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_helmet", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_helmet.iff", cost=3000},
		ith_armor_s01_leggings = { index=24, type=factionRewardType.armor, display="@wearables_name:ith_armor_s01_leggings", item="object/tangible/wearables/armor/ithorian_defender/ith_armor_s01_leggings.iff", cost=3000},
		armor_rebel_commando_helmet = { index=25, type=factionRewardType.armor, display="@wearables_name:helmet_s06", item="object/tangible/wearables/helmet/helmet_s06.iff", cost=3000}, 
