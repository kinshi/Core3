sentry_stormtrooper_rifleman = Creature:new {
	objectName = "",
	customName = "Stormtrooper Sentry Rifleman",
...
CreatureTemplates:addCreatureTemplate(sentry_stormtrooper_rifleman, "sentry_stormtrooper_rifleman")
