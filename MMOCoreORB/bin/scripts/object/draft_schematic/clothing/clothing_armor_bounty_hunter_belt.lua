...
templateType = DRAFTSCHEMATIC,
   ...
   customObjectName = "Bounty Hunter Armor Belt",
   ...
   resourceTypes = {"hide_leathery", "hide_scaley", "fiberplast", "metal", "petrochem_inert_polymer", "hide_wooly", "object/tangible/component/armor/shared_armor_segment_composite.iff", "object/tangible/component/clothing/shared_synthetic_cloth.iff", "object/tangible/component/clothing/shared_reinforced_fiber_panels.iff"},
