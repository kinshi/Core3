...
object_tangible_loot_loot_schematic_shared_lightsaber_one_hand_gen5_schematic = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/loot/loot_schematic/shared_lightsaber_one_hand_gen5_schematic.iff"
}

ObjectTemplates:addClientTemplate(object_tangible_loot_loot_schematic_shared_lightsaber_one_hand_gen5_schematic, "object/tangible/loot/loot_schematic/shared_lightsaber_one_hand_gen5_schematic.iff")
-- vipbunker house 
